...
for i=1:length(all_muscles)
    ...
    [fctcoutx,RMS,RMSLmt,involved_solids,num_markersprov,BiomechanicalModel,homocoeff]=MomentArmOptimisation(name_mus,BiomechanicalModel,MomentsArmRegression,LengthRegression);
    
    homocoeff
    
    fileID = fopen('via_points_finalAnconeus.txt','a');

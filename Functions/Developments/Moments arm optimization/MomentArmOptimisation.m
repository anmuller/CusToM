function [Pts,involved_solid,num_markers,BiomechanicalModel]=MomentArmOptimisation(name_mus,BiomechanicalModel,MomentsArmRegression)
...
options = optimoptions(@fmincon,'Algorithm','sqp','Display','final','TolFun',1e-6,'TolCon',1e-2,'MaxIterations',100000,'MaxFunEvals',10000,'StepTolerance',1e-14);%,'PlotFcn','optimplotfval');

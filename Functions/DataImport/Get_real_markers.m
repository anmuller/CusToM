...
% %     SCAPLOCB_epine_arr=[-0.106325551646658,-0.064652286888516,-0.058320663311548];
% %     SCAPLOCLM_epine_arr=[0.016930923971826,-0.029566592223417,0.059146995698055];
% %     SCAPLOCMM_epine_arr=[-0.085520277092290,0.023492788108463,-0.020965619483126];
% %     O_SCAP_av=[0.268450561523438,0.303168792724609,1.199984863281250];
% %     SCAPLOCB_epine_av=[-0.096698717365621,-0.083096646855050,-0.082256762444728];
% %     SCAPLOCLM_epine_av=[0.010450054201632,-0.047319577258633,0.050143908497945];
% %     SCAPLOCMM_epine_av=[-0.093814206003488,6.100934182518165e-04,-0.031583115482048];
% %     p=norm(O_SCAP_av-O_SCAP)/norm(O_SCAP_av-O_SCAP_arr);
% %     SCAPLOCB_epine=(SCAPLOCB_epine_av-SCAPLOCB_epine_arr)*p+SCAPLOCB_epine_av;
% %     SCAPLOCLM_epine=(SCAPLOCLM_epine_av-SCAPLOCLM_epine_arr)*p+SCAPLOCLM_epine_av;
% %     SCAPLOCMM_epine=(SCAPLOCMM_epine_av-SCAPLOCMM_epine_arr)*p+SCAPLOCMM_epine_av;

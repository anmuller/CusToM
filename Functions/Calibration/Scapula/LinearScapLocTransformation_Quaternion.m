function real_markers=LinearScapLocTransformation_Quaternion(Lastframe,Firstframe,real_markers,O_SCAP_ar,O_SCAP_av,...
...
for i=1:Lastframe-Firstframe+1
    ...
    Q_SCAPLOC_vers_epine = QuatSlerpAtHome(Q_SCAPLOC_vers_epine_ar,Q_SCAPLOC_vers_epine_av,p);

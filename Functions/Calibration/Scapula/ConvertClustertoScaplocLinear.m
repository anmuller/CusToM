function [new_name,p_trial,SCAPLOCB_trial,SCAPLOCMM_trial,SCAPLOCLM_trial]=ConvertClustertoScaplocLinear(filename_trial, filename_arr, filename_av, token_mean)
%% Open files

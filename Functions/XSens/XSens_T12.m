function [OsteoArticularJoint]= XSens_T12(OsteoArticularJoint,tree,Mass,AttachmentPoint,pose)
% Addition of a T12 model
%
%   INPUT
...
%% T12
    ...
    OsteoArticularJoint(incr_solid).child=s_T12_J2;                   
    ...
    OsteoArticularJoint(incr_solid).name=name;   
    OsteoArticularJoint(incr_solid).sister=0;                
    OsteoArticularJoint(incr_solid).child=s_T12;                   
    OsteoArticularJoint(incr_solid).mother=s_T12_J1;           
    ...
    OsteoArticularJoint(incr_solid).mother=s_T12_J2;
    OsteoArticularJoint(incr_solid).a=[0 0 1]';
    OsteoArticularJoint(incr_solid).joint=1;
    OsteoArticularJoint(incr_solid).ActiveJoint=1;
    OsteoArticularJoint(incr_solid).m=Mass_T12;
    OsteoArticularJoint(incr_solid).b=[0 0 0]';
    OsteoArticularJoint(incr_solid).I=[I_T12(1) I_T12(4) I_T12(5); I_T12(4) I_T12(2) I_T12(6); I_T12(5) I_T12(6) I_T12(3)];
    OsteoArticularJoint(incr_solid).c= c;
    OsteoArticularJoint(incr_solid).anat_position=T12_position_set;

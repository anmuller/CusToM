...
Toe_position_set = [Toe_position_set; ...
    {[SigneC 'ToePrediction2'], [Toe_position_set{5,2}(1);...
        (- OsteoArticularJoint(end).anat_position{2,2}(2) + OsteoArticularJoint(end).anat_position{4,2}(2));...
        Toe_position_set{2,2}(3)]}; ...
    {[SigneC 'ToePrediction3'], [((- OsteoArticularJoint(end).anat_position{2,2}(1) + OsteoArticularJoint(end).anat_position{4,2}(1)) + 5*Toe_position_set{5,2}(1))/6;...
        (- OsteoArticularJoint(end).anat_position{2,2}(2) + OsteoArticularJoint(end).anat_position{5,2}(2));...
        Toe_position_set{2,2}(3)]}; ...
    {[SigneC 'ToePrediction4'], [(3*(- OsteoArticularJoint(end).anat_position{2,2}(1) + OsteoArticularJoint(end).anat_position{4,2}(1)) + Toe_position_set{5,2}(1))/4;...
        (- OsteoArticularJoint(end).anat_position{2,2}(2) + OsteoArticularJoint(end).anat_position{4,2}(2));...
        Toe_position_set{2,2}(3)]}; ...
    {[SigneC 'ToePrediction5'], [(3*(- OsteoArticularJoint(end).anat_position{2,2}(1) + OsteoArticularJoint(end).anat_position{4,2}(1)) + Toe_position_set{5,2}(1))/4;...
        (- OsteoArticularJoint(end).anat_position{2,2}(2) + OsteoArticularJoint(end).anat_position{5,2}(2));...
        Toe_position_set{2,2}(3)]}; ...
    ];
Toe_position_set = [Toe_position_set; ...
    {[SigneC 'ToePrediction6'], [(3*(- OsteoArticularJoint(end).anat_position{2,2}(1) + OsteoArticularJoint(end).anat_position{4,2}(1)) + Toe_position_set{5,2}(1))/4;...
        (2*Toe_position_set{8,2}(2) + Toe_position_set{9,2}(2))/3;...
        Toe_position_set{2,2}(3)]}; ...
    {[SigneC 'ToePrediction7'], [(3*(- OsteoArticularJoint(end).anat_position{2,2}(1) + OsteoArticularJoint(end).anat_position{4,2}(1)) + Toe_position_set{5,2}(1))/4;...
        (Toe_position_set{8,2}(2) + 2*Toe_position_set{9,2}(2))/3;...
        Toe_position_set{2,2}(3)]}; ...
    ];

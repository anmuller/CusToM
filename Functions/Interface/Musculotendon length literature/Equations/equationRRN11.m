...
%
%   OUTPUT
%   - y : vector resulting from the equation (11)
...
if size(b,1)<75
    b=[b ; zeros(75-size(b,1),1)];    
    disp('Attention il manque des coeffs pour ce muscle (RRN11)');
end
...
+a(54).*q1.^3.*q2.^3.*q3+a(55).*q1.^3.*q2.*q3.^3+a(56).*q1.*q2.^3.*q3.^3+a(57).*q1.^5.*q2+a(58).*q1.^5.*q3+a(59).*q1.*q2.^5+a(60).*q2.^5.*q3+a(61).*q1.*q3.^5+...
+a(62).*q2.*q3.^5+a(63).*q1.^6.*q2+a(64).*q1.*q2.^6+a(65).*q1.^7.*q2+a(66).*q1.*q2.^7+a(67).*q1.^8.*q2+a(68).*q1.*q2.^8+a(69).*q1.^6.*q3+a(70).*q2.^6.*q3+a(71).*q1.^7.*q3+...
+a(72).*q2.^7.*q3+a(73).*q1.^8.*q3+a(74).*q2.^8.*q3;

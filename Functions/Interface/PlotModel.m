function [OsteoArticularModel,Markers,EnableModel] = PlotModel(ModelParameters,ax,seg_anim,muscles_anim,mod_marker_anim,exp_marker_anim,mass_centers_anim,Global_mass_center_anim,external_forces_anim,external_forces_pred,Anim)
...
if mass_centers_anim
    ...
    num_s_mass_center=find([Human_model_bis.Visual]);

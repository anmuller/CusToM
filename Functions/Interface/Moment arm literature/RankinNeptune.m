...
if strcmp(mus_name,'ExtensorCarpiRadialisBrevis')
    ...
    RegressionStructure(3).joints={'Wrist deviation Elbow flexion(+)/extension(-)r(+)/radial(-)','Wrist flexion(+)/extension(-)'};
    RegressionStructure(3).axe='Wrist deviation Elbow flexion(+)/extension(-)r(+)/radial(-)';
    ...
    RegressionStructure(4).joints={'Wrist deviation Elbow flexion(+)/extension(-)r(+)/radial(-)','Wrist flexion(+)/extension(-)'};
    ...
    elseif strcmp(axis,'Wrist deviation Elbow flexion(+)/extension(-)r(+)/radial(-)') || strcmp(axis,'Wrist deviation Elbow flexion(+)/extension(-)r(-)/radial(+)') 
        [~,indtemp1] = intersect(joints_names,{'Wrist deviation Elbow flexion(+)/extension(-)r(+)/radial(-)'});        
        [~,indtemp2] = intersect(joints_names,{'Wrist deviation Elbow flexion(+)/extension(-)r(-)/radial(+)'});         
    ...
    elseif strcmp(axis,'Wrist flexion(+)/extension(-)')
        [~,indtemp1] = intersect(joints_names,{'Wrist deviation Elbow flexion(+)/extension(-)r(+)/radial(-)'});                 [~,indtemp2] = intersect(joints_names,{'Wrist deviation Elbow flexion(+)/extension(-)r(-)/radial(+)'});                  ind1 = [indtemp1,indtemp2];
        [~,ind2] = intersect(joints_names,{'Wrist flexion(+)/extension(-)'});
        if ~isempty(ind1) && ~isempty(ind2)
            Q  = q([ind1,ind2],:)';

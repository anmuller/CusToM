function [Markers]=M2S_Manutention(nb_markers_hand)
% Definition of the markers set used in the M2S for manutention tasks
%
%   INPUT
...
for i=1:2
    Signe=Side{i};
    s=[s;{[Signe 'KNE'] [Signe 'KNE'] {'Off';'Off';'On'};...
        [Signe 'KNI'] [Signe 'KNI'] {'Off';'On';'On'}; [Signe 'ANE'] [Signe 'ANEManutention'] {'Off';'On';'Off'}; ...
        [Signe 'HEE'] [Signe 'HEEManutention'] {'On';'On';'Off'};[Signe 'TAR'] [Signe 'TARManutention'] {'Off';'On';'On'};...
        [Signe 'TARI'] [Signe 'TARIManutention'] {'Off';'On';'On'};
        }]; %#ok<AGROW>
end

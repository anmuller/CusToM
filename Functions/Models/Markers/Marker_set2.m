...
if length(varargin)>=1
    ...
    if Scapulalocator.active
        for idx=1:2
            ...
            if ~isempty(temp{:})
                s=[s;{['ScapLocAA_',Side{idx}] ['ScapLoc_AA_',Side{idx}] {'On';'On';'On'};...
                    ['ScapLocTS_',Side{idx}] ['ScapLoc_TS_',Side{idx}] {'On';'On';'On'};...
                    ['ScapLocAI_',Side{idx}] ['ScapLoc_AI_',Side{idx}] {'On';'On';'On'};...
                   }];
            end
        end
    end

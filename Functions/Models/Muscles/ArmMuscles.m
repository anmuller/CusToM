...
%     
       [Signe 'Anconeus'],350,0.075,[],[],[],{[Signe 'Humerus_Anconeus_o'];[Signe 'Humerus_Anconeus_VP1'];[Signe 'Ulna_Anconeus_VP2'];[Signe 'Ulna_Anconeus_i']},{};...
   [Signe 'FlexorCarpiUlnaris'],74,0.255,[],[],[],{[Signe 'Humerus_FlexorCarpiUlnaris_o'];[Signe 'Humerus_FlexorCarpiUlnaris_VP1'];[Signe 'Radius_FlexorCarpiUlnaris_VP2'];[Signe 'Radius_FlexorCarpiUlnaris_VP3'];[Signe 'Hand_FlexorCarpiUlnaris_VP4'];[Signe 'Hand_FlexorCarpiUlnaris_i']},{};...
    [Signe 'ExtensorCarpiUlnaris'],93.2,0.210,[],[],[],{[Signe 'Humerus_ExtensorCarpiUlnaris_o'];[Signe 'Humerus_ExtensorCarpiUlnaris_VP1'];[Signe 'Radius_ExtensorCarpiUlnaris_VP2'];[Signe 'Radius_ExtensorCarpiUlnaris_VP3'];[Signe 'Hand_ExtensorCarpiUlnaris_VP4'];[Signe 'Hand_ExtensorCarpiUlnaris_i']},{};...
   [Signe 'ExtensorCarpiRadialisLongus'],337.3,0.081,[],0.244,[],{[Signe 'Humerus_ExtensorCarpiRadialisLongus_o'];[Signe 'Humerus_ExtensorCarpiRadialisLongus_VP1'];[Signe 'Radius_ExtensorCarpiRadialisLongus_VP2'];[Signe 'Radius_ExtensorCarpiRadialisLongus_VP3'];[Signe 'Hand_ExtensorCarpiRadialisLongus_VP4'];[Signe 'Hand_ExtensorCarpiRadialisLongus_i']},{};...
    [Signe 'ExtensorCarpiRadialisBrevis'],252.5,0.0585,[],0.2223,[],{[Signe 'Humerus_ExtensorCarpiRadialisBrevis_o'];[Signe 'Humerus_ExtensorCarpiRadialisBrevis_VP1'];[Signe 'Radius_ExtensorCarpiRadialisBrevis_VP2'];[Signe 'Radius_ExtensorCarpiRadialisBrevis_VP3'];[Signe 'Hand_ExtensorCarpiRadialisBrevis_VP4'];[Signe 'Hand_ExtensorCarpiRadialisBrevis_i']},{};...
  [Signe 'FlexorCarpiRadialis'],74,0.235,[],[],[],{[Signe 'Humerus_FlexorCarpiRadialis_o'];[Signe 'Humerus_FlexorCarpiRadialis_VP1'];[Signe 'Radius_FlexorCarpiRadialis_VP2'];[Signe 'Radius_FlexorCarpiRadialis_VP3'];[Signe 'Hand_FlexorCarpiRadialis_VP4'];[Signe 'Hand_FlexorCarpiRadialis_i']},{};...
    [Signe 'PronatorQuadratus'],78,0.045,[],[],[],{[Signe 'Radius_PronatorQuadratus_o'];[Signe 'Radius_PronatorQuadratus_VP1'];[Signe 'Ulna_PronatorQuadratus_VP2'];[Signe 'Ulna_PronatorQuadratus_i']},{};...
    [Signe 'SupinatorBrevis'],30,0.050,[],[],[],{[Signe 'Radius_SupinatorBrevis_o'];[Signe 'Radius_SupinatorBrevis_VP1'];[Signe 'Ulna_SupinatorBrevis_VP2'];[Signe 'Ulna_SupinatorBrevis_i']},{};...
  [Signe 'Brachialis'],987.3,0.105,4,0.0535,0,{[Signe 'Humerus_Brachialis_o'];[Signe 'Humerus_Brachialis_VP1'];[Signe 'Ulna_Brachialis_VP2'];[Signe 'Ulna_Brachialis_i']},{};...
    [Signe 'Brachioradialis'],261.3,0.22,[],[],[],{[Signe 'Humerus_Brachioradialis_o'];[Signe 'Humerus_Brachioradialis_VP1'];[Signe 'Radius_Brachioradialis_VP2'];[Signe 'Radius_Brachioradialis_i']},{};...
    [Signe 'PronatorTeres'],566.2,0.07,[],[],[],{[Signe 'Humerus_PronatorTeres_o'];[Signe 'Humerus_PronatorTeres_VP1'];[Signe 'Radius_PronatorTeres_VP2'];[Signe 'Radius_PronatorTeres_i']},{};...
    ...
    [Signe 'PalmarisLongus'],624.3,0.114,4,0.098,0.157,{[Signe 'Humerus_PalmarisLongus_o'];[Signe 'Humerus_PalmarisLongus_VP1'];[Signe 'Radius_PalmarisLongus_VP2'];[Signe 'Radius_PalmarisLongus_VP3'];[Signe 'Hand_PalmarisLongus_VP4'];[Signe 'Hand_PalmarisLongus_i']},{};...

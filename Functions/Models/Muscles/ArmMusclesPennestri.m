...
s=[s;{
    ...
    [Signe 'PronatorQuadrus'],78,0.045,[],[],[],{[Signe 'Ulna_PronatorQuadrus_o'];[Signe 'Radius_PronatorQuadrus_i']},{['Wrap' Signe 'RadiusQuadratus']};...
    ...
    [Signe 'PronatorTeres'],566.2,0.07,[],[],[],{[Signe 'Humerus_PronatorTeres_o'];[Signe 'Radius_PronatorTeres_i']},{['Wrap' Signe 'HumerusTri']};...

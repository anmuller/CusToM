...
s=[s;{
    [Signe 'Coracobrachialis'],63,0.200,[],[],[],{[Signe 'Humerus_Coracobrachialis_o'];[Signe 'Thorax_Coracobrachialis_i']},{};...
    [Signe 'Deltoid_pos'],240,0.170,[],[],[],{[Signe 'Humerus_Deltoid_o'];[Signe 'Thorax_Deltoid_i']},{};...
    [Signe 'LatissimusDorsi'],260,0.135,[],[],[],{[Signe 'Humerus_LatissimusDorsi_o'];[Signe 'Thorax_LatissimusDorsi_i']},{};...
    [Signe 'PectoralisMajor'],210,0.190,[],[],[],{[Signe 'Humerus_PectoralisMajor_o'];[Signe 'Thorax_PectoralisMajor_i']},{};...
    [Signe 'Supraspinatus'],98,0.090,[],[],[],{[Signe 'Humerus_Supraspinatus_o'];[Signe 'Thorax_Supraspinatus_i']},{};...
    [Signe 'Infraspinatus'],210,0.105,[],[],[],{[Signe 'Humerus_Infraspinatus_o'];[Signe 'Thorax_Infraspinatus_i']},{};...
    ...
    [Signe 'BicepsBrachii2'],47,0.23,[],[],[],{[Signe 'Humerus_BicepsBrachii2_o'];[Signe 'Thorax_BicepsBrachii2_i']},{};...  
    [Signe 'TricepsBrachii2'],135,0.285,[],[],[],{[Signe 'Radius_TricepsBrachii2_o'];[Signe 'Thorax_TricepsBrachii2_i']},{};...
    [Signe 'BicepsBrachii1'],90,0.27,[],[],[],{[Signe 'Ulna_BicepsBrachii1_o'];[Signe 'Thorax_BicepsBrachii1_i']},{};...
    [Signe 'Anconeus'],40,0.075,[],[],[],{[Signe 'Humerus_Anconeus_o'];[Signe 'Ulna_Anconeus_i']},{};...
    [Signe 'TricepsBrachii1'],108,0.21,[],[],[],{[Signe 'Humerus_TricepsBrachii1_o'];[Signe 'Ulna_TricepsBrachii1_i']},{};...
    ...
    [Signe 'Brachialis'],167,0.105,4,0.0535,0,{[Signe 'Humerus_Brachialis_o'];[Signe 'Radius_Brachialis_i']},{};...
    [Signe 'Brachioradialis'],45,0.22,[],[],[],{[Signe 'Humerus_Brachioradialis_o'];[Signe 'Radius_Brachioradialis_i']},{};...

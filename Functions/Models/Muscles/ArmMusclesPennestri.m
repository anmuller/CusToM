...
%     [Signe 'Infraspinatus'],1210,0.105,[],[],[],{[Signe 'Humerus_Infraspinatus_o'];[Signe 'Thorax_Infraspinatus_i']},{};...
 ...
 %   [Signe 'CubitalisAnterior'],35,0.255,[],[],[],{[Signe 'Humerus_CubitalisAnterior_o'];[Signe 'Hand_CubitalisAnterior_i']},{};...
   ...
   [Signe 'ExtensorCarpiRadialisLongus'],337.3,0.081,[],0.244,[],{[Signe 'Humerus_ExtensorCarpiRadialisLongus_o'];[Signe 'Hand_ExtensorCarpiRadialisLongus_i']},{};...
   ...
   % [Signe 'FlexorDigitorumSuperior'],45,0.220,[],[],[],{[Signe 'Humerus_FlexorDigitorumSuperior_o'];[Signe 'Hand_FlexorDigitorumSuperior_i']},{};...
    ...
    [Signe 'PronatorQuadratus'],78,0.045,[],[],[],{[Signe 'Ulna_PronatorQuadratus_i'];[Signe 'Radius_PronatorQuadratus_o']},{};...
    [Signe 'SupinatorBrevis'],30,0.050,[],[],[],{[Signe 'Ulna_SupinatorBrevis_i'];[Signe 'Radius_SupinatorBrevis_o']},{};...
 %   [Signe 'AbductorDigitiV'],36,0.140,[],[],[],{[Signe 'Ulna_AbductorDigitiV_o'];[Signe 'Hand_AbductorDigitiV_i']},{};...    
    [Signe 'Brachialis'],987.3,0.105,4,0.0535,0,{[Signe 'Humerus_Brachialis_o'];[Signe 'Ulna_Brachialis_i']},{};...
    ...
    [Signe 'PalmarisLongus'],624.3,0.114,4,0.098,0.157,{[Signe 'Humerus_PalmarisLongus_o'];[Signe 'Hand_PalmarisLongus_i']},{};... arm26.osim
    ...
    [Signe 'Lat_1'],290.5,0.254,[],0.12,0.43633,{[Signe 'humerus_r_LAT1_r-P1'];[Signe 'Scapula_LAT1-P2'];[Signe 'Scapula_LAT1-P3'];[Signe 'Thorax_LAT1-P4'];[Signe 'Thorax_LAT1-P5']},{};...
    [Signe 'Lat_2'],317.5,0.2324,[],0.1765,0.33161,{[Signe 'humerus_r_LAT2_r-P1'];[Signe 'Scapula_LAT2-P2'];[Signe 'Scapula_LAT2-P3'];[Signe 'Thorax_LAT2-P4'];[Signe 'Thorax_LAT2-P5']},{};...
    [Signe 'Lat_3'],189,0.2789,[],0.1403,0.36652,{[Signe 'humerus_r_LAT3_r-P1'];[Signe 'Scapula_LAT3-P2'];[Signe 'Scapula_LAT3-P3'];[Signe 'Thorax_LAT3-P4'];[Signe 'Thorax_LAT3-P5']},{};...

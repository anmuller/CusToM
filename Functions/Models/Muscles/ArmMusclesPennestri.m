...
%     [Signe 'Infraspinatus'],1210,0.105,[],[],[],{[Signe 'Humerus_Infraspinatus_o'];[Signe 'Thorax_Infraspinatus_i']},{};...
   ...
   [Signe 'TricepsBrachii1'],936.3,0.21,[],[],[],{[Signe 'Humerus_TricepsBrachii1_o'];[Signe 'Humerus_TricepsBrachii_p1'];[Signe 'Ulna_TricepsBrachii1_i']},{};...%{['Wrap' Signe 'HumerusTri']};...
    ...
    [Signe 'Deltoid_ant'],1218.9,0.0976,[],0.093,0.38397,{[Signe '_humerus_r_DELT1_r-P1'];[Signe '_humerus_r_DELT1_r-P1'];[Signe '_Scapula_DELT1-P3'];[Signe '_clavicle_r_DELT1_r-P4']},{};...{['Wrap' Signe 'HumerusDelt']};... 
    [Signe 'Deltoid_mid'],1103.5,0.1078,[],0.1095,0.2618,{[Signe '_humerus_r_DELT2_r-P1'];[Signe '_Scapula_DELT2-P3'];[Signe '_Scapula_DELT2-P4']},{};...{['Wrap' Signe 'ThoraxGH']};...   
    [Signe 'Deltoid_pos'],201.6,0.1367,[],0.038,0.31416,{[Signe '_Scapula_DELT3-P1'];[Signe '_Scapula_DELT3-P2'];[Signe '_humerus_r_DELT3_r-P3']},{};...
    [Signe 'Lat_1'],290.5,0.254,[],0.12,0.43633,{[Signe '_humerus_r_LAT1_r-P1'];[Signe '_Scapula_LAT1-P2'];[Signe '_Scapula_LAT1-P3'];[Signe '_Thorax_LAT1-P4'];[Signe '_Thorax_LAT1-P5']},{};...
    [Signe 'Lat_2'],317.5,0.2324,[],0.1765,0.33161,{[Signe '_humerus_r_LAT2_r-P1'];[Signe '_Scapula_LAT2-P2'];[Signe '_Scapula_LAT2-P3'];[Signe '_Thorax_LAT2-P4'];[Signe '_Thorax_LAT2-P5']},{};...
    [Signe 'Lat_3'],189,0.2789,[],0.1403,0.36652,{[Signe '_humerus_r_LAT3_r-P1'];[Signe '_Scapula_LAT3-P2'];[Signe '_Scapula_LAT3-P3'];[Signe '_Thorax_LAT3-P4'];[Signe '_Thorax_LAT3-P5']},{};...
    [Signe 'PECM1'],444.3,0.1442,[],0.0028,0.29671,{[Signe '_humerus_r_PECM1_r-P1'];[Signe '_humerus_r_PECM1_r-P2'];[Signe '_Thorax_PECM1-P3'];[Signe '_clavicle_r_PECM1_r-P4']},{};...
    [Signe 'PECM2'],658.3,0.1385,[],0.089,0.45379,{[Signe '_humerus_r_PECM2_r-P1'];[Signe '_humerus_r_PECM2_r-P2'];[Signe '_Thorax_PECM2-P3'];[Signe '_Thorax_PECM2-P4'];[Signe '_Thorax_PECM2-P5']},{};... 
    [Signe 'PECM3'],498.1,0.1385,[],0.132,0.43633,{[Signe '_humerus_r_PECM3_r-P1'];[Signe '_humerus_r_PECM3_r-P2'];[Signe '_Thorax_PECM3-P3'];[Signe '_Thorax_PECM3-P4'];[Signe '_Thorax_PECM3-P5']},{};... 
    [Signe 'Infraspinatus'],1075.8,0.0755,[],0.0308,0.33161,{[Signe '_humerus_INFSP-P1'];[Signe '_Scapula_INFSP-P2']},{};...
    [Signe 'Supraspinatus'],499.2,0.0682,[],0.0395,0.12217,{[Signe '_humerus_SUPSP-P1'];[Signe '_Scapula_SUPSP-P2'];[Signe '_Scapula_SUPSP-P3']},{};...
    [Signe 'Coracobrachialis'],208.2,0.0932,[],0.097,0.47124,{[Signe '_Scapula_CORB-P1'];[Signe '_Scapula_CORB-P2'];[Signe '_humerus_CORB-P3']},{};...

...
%   [Signe 'BicepsBrachii1'],624.3,0.27,[],[],[],{[Signe 'Ulna_BicepsBrachii1_o'];[Signe 'Thorax_BicepsBrachii1_i']},{};...
 ...
 %   [Signe 'CubitalisAnterior'],35,0.255,[],[],[],{[Signe 'Humerus_CubitalisAnterior_o'];[Signe 'Hand_CubitalisAnterior_i']},{};...
    ...
    [Signe 'FlexorCarpiUlnaris_bis'],128.9,0.051,[],[],[],{[Signe 'Humerus_FlexorCarpiUlnaris_o'];[Signe 'Humerus_FlexorCarpiUlnaris_VP1'];[Signe 'ShadowRadius_FlexorCarpiUlnaris_VP2'];[Signe 'ShadowRadius_FlexorCarpiUlnaris_VP3'];[Signe 'Hand_FlexorCarpiUlnaris_VP4'];[Signe 'Hand_FlexorCarpiUlnaris_i']},{};...
    ...
    [Signe 'ExtensorCarpiUlnaris_bis'],93.2,0.062,[],[],[],{[Signe 'Humerus_ExtensorCarpiUlnaris_o'];[Signe 'Humerus_ExtensorCarpiUlnaris_VP1'];[Signe 'ShadowRadius_ExtensorCarpiUlnaris_VP2'];[Signe 'ShadowRadius_ExtensorCarpiUlnaris_VP3'];[Signe 'Hand_ExtensorCarpiUlnaris_VP4'];[Signe 'Hand_ExtensorCarpiUlnaris_i']},{};...
    ...
    [Signe 'ExtensorCarpiRadialisLongus_bis'],304.9,0.081,[],0.244,[],{[Signe 'Humerus_ExtensorCarpiRadialisLongus_o'];[Signe 'Humerus_ExtensorCarpiRadialisLongus_VP1'];[Signe 'ShadowRadius_ExtensorCarpiRadialisLongus_VP2'];[Signe 'ShadowRadius_ExtensorCarpiRadialisLongus_VP3'];[Signe 'Hand_ExtensorCarpiRadialisLongus_VP4'];[Signe 'Hand_ExtensorCarpiRadialisLongus_i']},{};...
    ...
    [Signe 'ExtensorCarpiRadialisBrevis_bis'],100.5,0.059,[],0.2223,[],{[Signe 'Humerus_ExtensorCarpiRadialisBrevis_o'];[Signe 'Humerus_ExtensorCarpiRadialisBrevis_VP1'];[Signe 'ShadowRadius_ExtensorCarpiRadialisBrevis_VP2'];[Signe 'ShadowRadius_ExtensorCarpiRadialisBrevis_VP3'];[Signe 'Hand_ExtensorCarpiRadialisBrevis_VP4'];[Signe 'Hand_ExtensorCarpiRadialisBrevis_i']},{};...
 ...
 %   [Signe 'AbductorDigitiV'],36,0.140,[],[],[],{[Signe 'Ulna_AbductorDigitiV_o'];[Signe 'Hand_AbductorDigitiV_i']},{};...    
    ...
    [Signe 'Brachioradialis_bis'],261.3,0.173,[],[],[],{[Signe 'Humerus_Brachioradialis_o'];[Signe 'Humerus_Brachioradialis_VP1'];[Signe 'ShadowRadius_Brachioradialis_VP2'];[Signe 'ShadowRadius_Brachioradialis_i']},{};...
    ...
    [Signe 'PronatorTeres_bis'],566.2,0.049,[],[],[],{[Signe 'Humerus_PronatorTeres_o'];[Signe 'Humerus_PronatorTeres_VP1'];[Signe 'ShadowRadius_PronatorTeres_VP2'];[Signe 'ShadowRadius_PronatorTeres_i']},{};...
    ...
    [Signe 'PalmarisLongus_bis'],26.7,0.064,4,0.098,0.157,{[Signe 'Humerus_PalmarisLongus_o'];[Signe 'Humerus_PalmarisLongus_VP1'];[Signe 'ShadowRadius_PalmarisLongus_VP2'];[Signe 'ShadowRadius_PalmarisLongus_VP3'];[Signe 'Hand_PalmarisLongus_VP4'];[Signe 'Hand_PalmarisLongus_i']},{};...
...
% on conserve les biceps du modèle de Holzbaur sauf qu'on part de la
    % scapula pour le biceps short et glénoïde pour le biceps long
     ...
     [Signe 'BicepsL_bis'],624.3,0.1157,4,0.2723,0,{[Signe 'Scapula_BicepsL_o'];[Signe 'Scapula_BicepsL_via1'];[Signe 'Humerus_BicepsL_via2'];[Signe 'Humerus_BicepsL_via3'];[Signe 'Humerus_BicepsL_via4'];[Signe 'Humerus_BicepsL_via5'];[Signe 'Humerus_BicepsL_via6'];[Signe 'Humerus_Biceps_via7'];[Signe 'ShadowRadius_Biceps_i']},{};... arm26.osim       
     ...
     [Signe 'BicepsS_bis'],435.56,0.1321,4,0.1923,0,{[Signe 'Scapula_BicepsS_o'];[Signe 'Scapula_BicepsS_via1'];[Signe 'Humerus_BicepsS_via2'];[Signe 'Humerus_BicepsS_via3'];[Signe 'Humerus_Biceps_via7'];[Signe 'ShadowRadius_Biceps_i']},{};... arm26.osim    

...
Radius_position_set = {...
 ...
 %   [Signe 'Radius_PronatorTeres_i'], Radius_ElbowJointNode'+k_Pennestri2custom*[0 0 -1;-1 0 0;0 -1 0]*[0.055 -0.011 0.024]' + k*Mirror*[0.01 0 -0.01]';... 
  ...
  %   [Signe 'Radius_PronatorQuadrus_i'], Radius_ElbowJointNode'+k_Pennestri2custom*[0 0 -1;-1 0 0;0 -1 0]*[0.236 -0.005 0.012]' + k*Mirror*[0  0 -0.01]';...
    ...
    [Signe 'Radius_SupinatorBrevis_o'],Mirror*Forearm_osim2antoine'.*(([0.01201;-0.0517;-0.00107])-CoM_radius);...
    [Signe 'Radius_PronatorQuadratus_o'],Mirror*Forearm_osim2antoine'.*(([0.03245;-0.19998;0.01962])-CoM_radius);...
...
[Signe 'Ulna_TricepsLat_i'],Mirror*Forearm_osim2antoine'.*(([-0.0219;0.01046;-0.00078])-CoM_ulna) ;...
[Signe 'Ulna_TricepsMed_i'],Mirror*Forearm_osim2antoine'.*(([-0.0219;0.01046;-0.00078])-CoM_ulna)  ;...
[Signe 'Ulna_Anconeus_i'],Mirror*Forearm_osim2antoine'.*(([-0.02532;-0.00124;0.006])-CoM_ulna) ;...
[Signe 'Ulna_SupinatorBrevis_i'],Mirror*Forearm_osim2antoine'.*(([-0.0136;-0.03384;0.02013])-CoM_ulna) ;...
[Signe 'Ulna_Brachialis_i'],Mirror*Forearm_osim2antoine'.*(([-0.0032;-0.0239;0.0009])-CoM_ulna)  ;...
[Signe 'Ulna_PronatorTeres_i'],Mirror*Forearm_osim2antoine'.*(([0.00846;-0.03373;-0.01432])-CoM_ulna);...
[Signe 'Ulna_PronatorQuadratus_i'],Mirror*Forearm_osim2antoine'.*(([0.00193;-0.20972;0.03632])-CoM_ulna) ;...

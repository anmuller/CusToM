...
Radius_position_set = {...
    ...
    [Signe 'Radius_Brachialis_i'],Radius_ElbowJointNode'+Pennestri2custom*[0.033 0.005 0.001]';...
        ...
        %%ATTENTION LIGNE CHANGEE POUR TEST
    [Signe 'Radius_Brachioradialis_i'], Radius_ElbowJointNode'+L_forearm/(cr+dr)*k*[0 0 -1;-1 0 0;0 -1 0]*[0.238 -0.012 0]';...
        %%ATTENTION LIGNE CHANGEE POUR TEST
    [Signe 'Radius_PronatorTeres_i'], Radius_ElbowJointNode'+k_Pennestri2custom*[0 0 -1;-1 0 0;0 -1 0]*[0.055 -0.011 0.024]' + k*Mirror*[0.01 0 -0.01]';... % Ajout d'un terme correctif

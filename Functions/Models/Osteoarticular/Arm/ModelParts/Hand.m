...
Hand_position_set= {...
   ...
   + Hand_WristJointNode';...
    [Signe 'Hand_ExtensorCarpiRadialisLongus_VP4'], k*Mirror*[-0.0214 ; -0.0157 ; 0.0201] + Hand_WristJointNode' ;... 

    [Signe 'Hand_ExtensorCarpiRadialisBrevis_i'],Mirror*osim2antoine'.*([0.005;-0.01136;0.0085])  + Wrist_origin...
   + Hand_WristJointNode';...
   [Signe 'Hand_ExtensorCarpiRadialisBrevis_VP4'], k*Mirror*[-0.0263 ; -0.0206 ; 0.0130] + Hand_WristJointNode' ;... 
    
     [Signe 'Hand_ExtensorCarpiUlnaris_i'],Mirror*osim2antoine'.*([-0.02251;-0.01401;-0.00128] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_ExtensorCarpiUlnaris_VP4'], k*Mirror*[0.0059 ; -0.0046 ; 0.0244] + Hand_WristJointNode';...
   ...
   + Hand_WristJointNode';...
    [Signe 'Hand_FlexorCarpiUlnaris_VP4'], k*Mirror*[0.0229 ; -0.0176 ; -0.0184] + Hand_WristJointNode';...
    
    [Signe 'Hand_PalmarisLongus_i'],Mirror*osim2antoine'.*([0.00227;-0.03096;0.00493] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_PalmarisLongus_VP4'], k*Mirror*[0.0032 ; -0.0359 ; -0.0003] + Hand_WristJointNode';...

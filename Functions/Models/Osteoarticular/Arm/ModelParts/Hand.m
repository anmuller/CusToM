...
Hand_position_set= {...
   ...
   + Hand_WristJointNode';...
    [Signe 'Hand_ExtensorCarpiRadialisLongus_VP4'], k*Mirror*[-0.0227 ; -0.0167 ; 0.0212] + Hand_WristJointNode' ;... 

    [Signe 'Hand_ExtensorCarpiRadialisBrevis_i'],Mirror*osim2antoine'.*([0.005;-0.01136;0.0085])  + Wrist_origin...
   + Hand_WristJointNode';...
   [Signe 'Hand_ExtensorCarpiRadialisBrevis_VP4'], k*Mirror*[-0.0279 ; -0.0218 ; 0.0138] + Hand_WristJointNode' ;... 
    
     [Signe 'Hand_ExtensorCarpiUlnaris_i'],Mirror*osim2antoine'.*([-0.02251;-0.01401;-0.00128] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_ExtensorCarpiUlnaris_VP4'], k*Mirror*[-0.0079 ; 0.0000 ; -0.0301] + Hand_WristJointNode';...
    
    [Signe 'Hand_FlexorCarpiRadialis_i'],Mirror*osim2antoine'.*([0.01124;-0.01844;-0.00418] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_FlexorCarpiRadialis_VP4'], k*Mirror*[0.0171 ; -0.0194 ; 0.0124] + Hand_WristJointNode';...
    
    [Signe 'Hand_FlexorCarpiUlnaris_i'],Mirror*osim2antoine'.*([-0.02036;-0.01765;-0.00752])  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_FlexorCarpiUlnaris_VP4'], k*Mirror*[0.0243 ; -0.0186 ; -0.0194] + Hand_WristJointNode';...
    
    [Signe 'Hand_PalmarisLongus_i'],Mirror*osim2antoine'.*([0.00227;-0.03096;0.00493] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_PalmarisLongus_VP4'], k*Mirror*[-0.0311 ; -0.0236 ; 0.0007] + Hand_WristJointNode';...

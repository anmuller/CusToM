...
Hand_position_set= {...
   ...
   + Hand_WristJointNode';...
    [Signe 'Hand_ExtensorCarpiRadialisLongus_VP4'], k*Mirror*[-0.0043 ; -0.0031 ; 0.0040] + Hand_WristJointNode' ;... 

    [Signe 'Hand_ExtensorCarpiRadialisBrevis_i'],Mirror*osim2antoine'.*([0.005;-0.01136;0.0085])  + Wrist_origin...
   + Hand_WristJointNode';...
   [Signe 'Hand_ExtensorCarpiRadialisBrevis_VP4'], k*Mirror*[-0.0053 ; -0.0041 ; 0.0026] + Hand_WristJointNode' ;... 
    
     [Signe 'Hand_ExtensorCarpiUlnaris_i'],Mirror*osim2antoine'.*([-0.02251;-0.01401;-0.00128] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_ExtensorCarpiUlnaris_VP4'], k*Mirror*[0.0012 ; -0.0009 ; 0.0049] + Hand_WristJointNode';...
    
    [Signe 'Hand_FlexorCarpiRadialis_i'],Mirror*osim2antoine'.*([0.01124;-0.01844;-0.00418] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_FlexorCarpiRadialis_VP4'], k*Mirror*[0.0161 ; -0.0183 ; 0.0117] + Hand_WristJointNode';...
    
    [Signe 'Hand_FlexorCarpiUlnaris_i'],Mirror*osim2antoine'.*([-0.02036;-0.01765;-0.00752])  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_FlexorCarpiUlnaris_VP4'], k*Mirror*[0.0032 ; -0.0037 ; 0.0023] + Hand_WristJointNode';...
    
    [Signe 'Hand_PalmarisLongus_i'],Mirror*osim2antoine'.*([0.00227;-0.03096;0.00493] )  + Wrist_origin ...
   + Hand_WristJointNode';...
    [Signe 'Hand_PalmarisLongus_VP4'], k*Mirror*[0.0006 ; -0.0072 ; -0.0001] + Hand_WristJointNode';...

...
%     [Signe 'Humerus_Triceps_o'], (Humerus_Triceps+Humerus_ghJointNode)'; ...
    ...
    [Signe 'Humerus_Coracobrachialis_o'],Pennestri2custom*[0.02 0.03 0.035]';...
    [Signe 'Humerus_Deltoid_o'],Pennestri2custom*[ -0.03 0.04 0.015]';...
    [Signe 'Humerus_LatissimusDorsi_o'],Pennestri2custom*[ -0.035 0.09 -0.125]';...
    [Signe 'Humerus_PectoralisMajor_o'],Pennestri2custom*[ 0.045 0.095 -0.125]';...
    [Signe 'Humerus_Supraspinatus_o'],Pennestri2custom*[ -0.02 0.09 0.035]';...
    [Signe 'Humerus_Infraspinatus_o'],Pennestri2custom*[ -0.015 0.08 -0.04]';...
    [Signe 'Humerus_Trapezius_o'],Pennestri2custom*[0 0.08 0.01]';...
    [Signe 'Humerus_BicepsBrachii2_o'],Pennestri2custom*[0 -0.015 0.01]';...
    [Signe 'Humerus_Anconeus_o'],Pennestri2custom*[0.265 0.005 -0.019]';...
    [Signe 'Humerus_TricepsBrachii1_o'],Pennestri2custom*[0.078 0.011 -0.01]';...
    [Signe 'Humerus_Brachialis_o'],Pennestri2custom*[0.176 -0.008 0.016]';...
    [Signe 'Humerus_Brachioradialis_o'],Pennestri2custom*[0.246 -0.027 0]';...
    [Signe 'Humerus_PronatorTeres_o'],Pennestri2custom*[0.22 0.033 -0.005]';...
    [Signe 'Humerus_CubitalisAnterior_o'],Pennestri2custom*[ 0.149 0.024 0.005]';...
    [Signe 'Humerus_FlexorCarpiUlnaris_o'],Pennestri2custom*[ 0.249 0.027 0]';...
    [Signe 'Humerus_ExtensorCarpiUlnaris_o'],Pennestri2custom*[ 0.249 0.027 0]';...

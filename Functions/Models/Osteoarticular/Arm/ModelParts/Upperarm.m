...
%    [Signe 'Humerus_FlexorCarpiRadialis_o'],Pennestri2custom*[ 0.249 0.027 0]'+Humerus_ghJointNode';...
  %   [Signe 'Humerus_FlexorCarpiRadialis_o'],Humerus_RadiusJointNode'+k*Mirror*[0 0.001 0]';... %Change to look like wrist model in OpenSim
    ...
    [Signe 'Humerus_Brachioradialis_o'],Mirror*osim2antoine'.*(([-0.0098;-0.19963;0.00223])-CoM_humerus);...
    [Signe 'Humerus_TricepsLat_o'],Mirror*osim2antoine'.*(([-0.00599;-0.12646;0.00428])-CoM_humerus);...
    [Signe 'Humerus_TricepsMed_o'],Mirror*osim2antoine'.*(([-0.00838;-0.13695;-0.00906])-CoM_humerus);...
    [Signe 'Humerus_Anconeus_o'],Mirror*osim2antoine'.*(([-0.00744;-0.28359;0.00979])-CoM_humerus);...
    [Signe 'Humerus_Brachialis_o'],Mirror*osim2antoine'.*(([0.0068;-0.1739;-0.0036])-CoM_humerus);...
    [Signe 'Humerus_PronatorTeres_o'],Mirror*osim2antoine'.*(([0.0036;-0.2759;-0.0365])-CoM_humerus);...
    [Signe 'Humerus_FlexorCarpiUlnaris_o'],Mirror*osim2antoine'.*(([0.00219;-0.2774;-0.0388])-CoM_humerus);...
    [Signe 'Humerus_ExtensorCarpiUlnaris_o'],Mirror*osim2antoine'.*(([0.00083;-0.28955;0.0188])-CoM_humerus);...
    [Signe 'Humerus_FlexorCarpiRadialis_o'],Mirror*osim2antoine'.*(([0.00758;-0.27806;-0.03705])-CoM_humerus);...
    [Signe 'Humerus_PalmarisLongus_o'],Mirror*osim2antoine'.*(([0.00457;-0.27519;-0.03865])-CoM_humerus);...
    [Signe 'Humerus_ExtensorCarpiRadialisLongus_o'],Mirror*osim2antoine'.*(([-0.0073;-0.2609;0.0091])-CoM_humerus);...
    [Signe 'Humerus_ExtensorCarpiRadialisBrevis_o'],Mirror*osim2antoine'.*(([0.01349;-0.29048;0.01698])-CoM_humerus);...

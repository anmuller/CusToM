...
%     [Signe 'Humerus_Triceps_o'], (Humerus_Triceps+Humerus_ghJointNode)'; ...
    ...
    [Signe 'Humerus_FlexorCarpiUlnaris_o'],L_humerus/(eh-dh)*k*Mirror*[0 0 1;-1 0 0;0 1 0]*[ 0.249 0.027 0]'+Humerus_ghJointNode'+k*Mirror*[-0.02 -0.04 0]';...% addition of a manual correcion term
   
    [Signe 'Humerus_ExtensorCarpiUlnaris_o'],Pennestri2custom*[ 0.249 0.027 0]'+Humerus_ghJointNode'+k*Mirror*[0.05 0 0.05]';...% addition of a manual correcion term
    
    [Signe 'Humerus_ExtensorDigitorum_o'],Pennestri2custom*[ 0.242 0.02 -0.02]'+Humerus_ghJointNode'+k*Mirror*[0.01 -0.05 0]';...% addition of a manual correcion term

    [Signe 'Humerus_FlexorDigitorumSuperior_o'],Pennestri2custom*[ 0.227 0.011 0.021]'+Humerus_ghJointNode'+k*Mirror*[-0.03 -0.1 0]';...

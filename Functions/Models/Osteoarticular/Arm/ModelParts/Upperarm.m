...
%     [Signe 'Humerus_Triceps_o'], (Humerus_Triceps+Humerus_ghJointNode)'; ...
    ...
    [Signe '_humerus_r_LAT1_r-P1'],osim2antoine.*Mirror*([0.0105;-0.03415;-0.00653])+Humerus_ghJointNode';...
    [Signe '_humerus_r_LAT2_r-P1'],osim2antoine.*Mirror*([0.00968;-0.04071;-0.00611])+Humerus_ghJointNode';...
    [Signe '_humerus_r_LAT3_r-P1'],osim2antoine.*Mirror*([0.01208;-0.03922;-0.00416])+Humerus_ghJointNode';...
    [Signe '_humerus_SUPSP-P1'],osim2antoine.*Mirror*([0.00256;0.01063;0.02593])+Humerus_ghJointNode';...
    [Signe '_humerus_INFSP-P1'],osim2antoine.*Mirror*([-0.00887;0.00484;0.02448])+Humerus_ghJointNode';...
    [Signe '_humerus_CORB-P3'],osim2antoine.*Mirror*([0.00743;-0.15048;-0.00782])+Humerus_ghJointNode';...

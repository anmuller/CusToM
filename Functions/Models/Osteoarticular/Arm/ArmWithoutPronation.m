function [OsteoArticularModel]= ArmWithoutPronation(OsteoArticularModel,k,Signe,Mass,AttachmentPoint)
% Addition of an arm model
%   This arm model contains 3 solids (upper arm, forearm and hand),
%   exhibits 3 dof for the shoulder, 1 dof for the elbow and 2 dof for the
%   wrist
%
%	Based on:
...
[OsteoArticularModel]= ForearmWithoutPronation(OsteoArticularModel,k,Signe,Mass,[Signe 'Humerus_ElbowJointNode']);

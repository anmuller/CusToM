function [OsteoArticularModel]= Arm_Shoulder_Pennestri(OsteoArticularModel,k,Signe,Mass,AttachmentPoint)
...
% Georges Dumont
%________________________________________________________
[OsteoArticularModel]= Upperarm_Shoulder(OsteoArticularModel,k,Signe,Mass,AttachmentPoint);
[OsteoArticularModel]= Forearm_Pennestri_model_definition(OsteoArticularModel,k,Signe,Mass,[Signe 'Humerus_ElbowJointNode']);

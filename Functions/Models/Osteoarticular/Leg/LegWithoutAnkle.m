function [OsteoArticularModel]= LegWithoutAnkle(OsteoArticularModel,k,Signe,Mass,AttachmentPoint)
% Addition of a leg model
%   This leg model contains 2 solids (thigh and shank/foot),
%   exhibits 3 dof for the hip, 1 dof for the knee
%
%	Based on:
...
[OsteoArticularModel]= ShankFoot(OsteoArticularModel,k,Signe,Mass,[Signe 'Thigh_KneeJointNode']);

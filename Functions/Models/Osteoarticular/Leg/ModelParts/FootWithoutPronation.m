function [OsteoArticularModel]= FootWithoutPronation(OsteoArticularModel,k,Signe,Mass,AttachmentPoint)
...
% Optimisation of the axis of rotation of the ankle (talocrural)

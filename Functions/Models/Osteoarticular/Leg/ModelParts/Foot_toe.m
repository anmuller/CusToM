...
%    [Signe 'Foot_ToetipNode'], Foot_ToetipNode'; ...
 ['Test' Signe 'Foot'],k*Mirror*[ -0.0217 ;  -0.0475;   -0.0050];...
...
%     Human_model(incr_solid).v= [ [1; 0; 0] , [0 ;1;0] ] ;
    ...
    OsteoArticularModel(incr_solid).m=Mass.Foot_Mass;%Mass.Foot_Mass*(2/3);
    OsteoArticularModel(incr_solid).b=[0 0 0]';
    OsteoArticularModel(incr_solid).I=[I_Foot(1) I_Foot(4) I_Foot(5); I_Foot(4) I_Foot(2) I_Foot(6); I_Foot(5) I_Foot(6) I_Foot(3)];%(2/3)*[I_Foot(1) I_Foot(4) I_Foot(5); I_Foot(4) I_Foot(2) I_Foot(6); I_Foot(5) I_Foot(6) I_Foot(3)];
    OsteoArticularModel(incr_solid).c=-(1)*Foot_AnkleJointNode';
...
if Signe == 'R'
 ...
 % Foot Toe
    ...
    OsteoArticularModel(incr_solid).limit_sup=pi/2;
    OsteoArticularModel(incr_solid).Visual=1;
    OsteoArticularModel(incr_solid).m=Mass.Foot_Mass*0; %Mass.Foot_Mass*(1/3);
    OsteoArticularModel(incr_solid).b=-Foot_AnkleJointNode'+k*Mirror*[ 0   -0.0475   0]';%k*Mirror*[ -0.0217   -0.0475   -0.0050]'; %Foot_ToetipNode%-(4/3)*Foot_AnkleJointNode';%[0 -k*0.0504 0]'; % metartarse mean position 
    OsteoArticularModel(incr_solid).I=0*[I_Foot(1) I_Foot(4) I_Foot(5); I_Foot(4) I_Foot(2) I_Foot(6); I_Foot(5) I_Foot(6) I_Foot(3)];%(1/3)*[I_Foot(1) I_Foot(4) I_Foot(5); I_Foot(4) I_Foot(2) I_Foot(6); I_Foot(5) I_Foot(6) I_Foot(3)];
    OsteoArticularModel(incr_solid).c=-(1)*Foot_AnkleJointNode';%0*Mirror*[ 0   -0.0475   0]';%0*Foot_AnkleJointNode';%-(1/3)*Foot_AnkleJointNode';
  ...
  %  [Signe 'HEE'], k*Mirror*[-0.009479 0.12946 -0.02]'; ...
    [Signe 'TAR'], k*Mirror*[-0.021708 -0.04 0.04]'-OsteoArticularModel(incr_solid).b; ...
    [Signe 'TOE'], k*Mirror*[-0.02 -0.11625 -0.015]'-OsteoArticularModel(incr_solid).b; ...
    [Signe 'TARI'], k*Mirror*[-0.021708 -0.055 -0.05]'-OsteoArticularModel(incr_solid).b; ...
%    [Signe 'Foot_AnkleJointNode'], Foot_AnkleJointNode'; ...
    [Signe 'Foot_ToetipNode'], Foot_ToetipNode'-OsteoArticularModel(incr_solid).b; ...
    ['MetatarsalJoint1' Signe 'Foot'],k*Mirror*[-0.0275;-0.06025;-0.03]-OsteoArticularModel(incr_solid).b;...
    ['MetatarsalJoint2' Signe 'Foot'],k*Mirror*[-0.0325;-0.06275;-0.005]-OsteoArticularModel(incr_solid).b;...
    ['MetatarsalJoint3' Signe 'Foot'],k*Mirror*[-0.0325;-0.05525;0.007]-OsteoArticularModel(incr_solid).b;...
    ['MetatarsalJoint4' Signe 'Foot'],k*Mirror*[-0.0375;-0.04025;0.017]-OsteoArticularModel(incr_solid).b;...
    ['MetatarsalJoint5' Signe 'Foot'],k*Mirror*[-0.0375;-0.03325;0.03]-OsteoArticularModel(incr_solid).b;...
%    ['MalleousLateral' Signe 'Foot'],k*Mirror*[0.0325;0.06275;0.005];...
%    ['Soleus' Signe 'Foot'],k*Mirror*[-0.0045;0.11775;-0.021]-OsteoArticularModel(incr_solid).b;...
%    ['Gastrocnemius' Signe 'Foot'],k*Mirror*[-0.0045;0.11775;-0.021]-OsteoArticularModel(incr_solid).b;...
%    ['TibialisPosterior' Signe 'Foot'],k*Mirror*[-0.0205;0.01675;-0.04]-OsteoArticularModel(incr_solid).b;...
%    ['TibialisPosteriorVia' Signe 'Foot'],k*Mirror*[0.0045;0.09475;-0.04]-OsteoArticularModel(incr_solid).b;...
%    ['FlexorDigitorumLongus' Signe 'Foot'],k*Mirror*[-0.0455;-0.09025;0.02];...
%    ['FlexorDigitorumLongusVia' Signe 'Foot'],k*Mirror*[0.0045;0.07975;-0.04];...
    ['FlexorHallucisLongus' Signe 'Foot'],k*Mirror*[-0.0405;-0.10325;-0.021]-OsteoArticularModel(incr_solid).b;...
%    ['FlexorHallucisLongusVia' Signe 'Foot'],k*Mirror*[-0.0055;0.08975;-0.03]-OsteoArticularModel(incr_solid).b;...
%    ['PeroneusBrevis' Signe 'Foot'],k*Mirror*[-0.0285;0.03475;0.016];...
%    ['PeroneusBrevisVia' Signe 'Foot'],k*Mirror*[0.0045;0.07975;-0.002];...
%    ['TibialisAnterior' Signe 'Foot'],k*Mirror*[-0.0025;0.00975;-0.04];...
%    ['TibialisAnteriorVia' Signe 'Foot'],k*Mirror*[0.0225;0.02475;-0.03];...
    ['ExtensorDigitorumLongus' Signe 'Foot'],k*Mirror*[-0.0395;-0.09025;0.02]-OsteoArticularModel(incr_solid).b;...
%    ['ExtensorDigitorumVia' Signe 'Foot'],k*Mirror*[0.0225;0.02475;-0.01];...
    ['ExtensorHallucisLongus' Signe 'Foot'],k*Mirror*[-0.0355;-0.10325;-0.021]-OsteoArticularModel(incr_solid).b;...
%    ['ExtensorHallucisVia' Signe 'Foot'],k*Mirror*[0.0225;0.02475;-0.02];...
%     [Signe 'FootPrediction1'], k*Mirror*[-0.04;0.1185;-0.03]*0.9359;...
%     [Signe 'FootPrediction2'], k*Mirror*[-0.04;0.1185;-0.007]*0.9359;...
%     [Signe 'FootPrediction3'], k*Mirror*[-0.03;0.035;0.015]*0.9359;...
%     [Signe 'FootPrediction4'], k*Mirror*[-0.025;0.01;-0.04]*0.9359;...
    [Signe 'FootPrediction5'], k*Mirror*[-0.04;-0.0525;-0.035]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction6'], k*Mirror*[-0.035;-0.0525;-0.0125]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction7'], k*Mirror*[-0.03;-0.045;0.0015]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction8'], k*Mirror*[-0.04;-0.035;0.015]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction9'], k*Mirror*[-0.04;-0.02;0.025]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction10'], k*Mirror*[-0.04;-0.075;0.04]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction11'], k*Mirror*[-0.045;-0.117;0.002]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction12'], k*Mirror*[-0.04;-0.095;-0.025]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction13'], k*Mirror*[-0.045;-0.1;0.015]*0.9359-OsteoArticularModel(incr_solid).b;...
    [Signe 'FootPrediction14'], k*Mirror*[-0.045;-0.09;0.03]*0.9359-OsteoArticularModel(incr_solid).b;...
%    [Signe 'HEEManutention'], k*Mirror*[0.035 0.12946 -0.02]'; ... 
    [Signe 'TARManutention'], k*Mirror*[-0.01 -0.04 0.04]'-OsteoArticularModel(incr_solid).b; ... 
    [Signe 'TARIManutention'], k*Mirror*[-0.01 -0.055 -0.05]'-OsteoArticularModel(incr_solid).b; ... %    [Signe 'ANEManutention'], k*Mirror*[0.01 0.05 0.015]'-OsteoArticularModel(incr_solid).b; ... 
%    [Signe 'FootMID'], k*Mirror*[ -0.0182 0.0066 -0.0050]'; ... 
    };

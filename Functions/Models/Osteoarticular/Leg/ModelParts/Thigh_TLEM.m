...
%Centre de masse
CoM_Thigh=(k*Mirror*[-0.0088	;0.2217;	0.0208]); % dans le rep�re femur

% Position des noeuds (-CoM pour placer dans un rep�re centr� en son centre
% de masse)
...
Human_model(incr_solid).comment='Hip Flexion(+)/Extension(-) - Z-Rotation';

function [OsteoArticularModel]= LegBallJoint(OsteoArticularModel,k,Signe,Mass,AttachmentPoint)
% Addition of a leg model
%   This leg model contains 3 solids (thigh, shank and foot),
%   exhibits 3 dof for the hip, 3 dof for the knee and 3 dof for the
%   ankle
%
%	Based on:
...
[OsteoArticularModel]= ShankBallJoint(OsteoArticularModel,k,Signe,Mass,[Signe 'Thigh_KneeJointNode']);
[OsteoArticularModel]= FootBallJoint(OsteoArticularModel,k,Signe,Mass,[Signe 'Shank_AnkleJointNode']);

...
Thorax_position_set= {...
    ...
    ['RThorax_Rhomboideus_I_VP1'], k*[ 0.0238 ; 0.2980 ; 0.0582] - CoM_Thorax' ;... 
    ['LThorax_Rhomboideus_I_VP1'], k*[ 0.0238 ; 0.2980 ; -0.0582] - CoM_Thorax' ;... 

    ['RThorax_PectoralisMajorThorax_I_VP1'], k*[ 0.1393 ; 0.4325 ; -0.0810] - CoM_Thorax' ;... 
    ['LThorax_PectoralisMajorThorax_I_VP1'], k*[  0.1393 ; 0.4325 ; 0.0810] - CoM_Thorax' ;... 

    ['RThorax_PectoralisMajorThorax_M_VP1'], k*[0.1148 ; 0.2172 ; 0.0273] - CoM_Thorax' ;... 
    ['LThorax_PectoralisMajorThorax_M_VP1'], k*[0.1148 ; 0.2172 ; -0.0273] - CoM_Thorax' ;... 

    
    ['RThorax_TrapeziusScapula_M_VP1'], k*[0.0357 ; 0.2980 ; -0.1061]  - CoM_Thorax' ;... 
    ['LThorax_TrapeziusScapula_M_VP1'], k*[0.0357 ; 0.2980 ; 0.1061] - CoM_Thorax' ;... 

    ['RThorax_TrapeziusScapula_S_VP1'], k*[0.0561 ; 0.2980 ; -0.0868] - CoM_Thorax' ;... 
    ['LThorax_TrapeziusScapula_S_VP1'], k*[0.0561 ; 0.2980 ; 0.0868] - CoM_Thorax' ;... 

    ['RThorax_TrapeziusScapula_I_VP1'], k*[-0.0936 ; 0.2980 ; -0.1017] - CoM_Thorax' ;... 
    ['LThorax_TrapeziusScapula_I_VP1'], k*[ -0.0936 ; 0.2980 ; 0.1017] - CoM_Thorax' ;... 

    [ 'RThorax_TrapeziusClavicle_S_VP1'], k*[ 0.0537 ; 0.2980 ; 0.0397] -  CoM_Thorax' ;... 
    [ 'LThorax_TrapeziusClavicle_S_VP1'], k*[ 0.0537 ; 0.2980 ; -0.0397] -  CoM_Thorax' ;... 
    
    [ 'RThorax_LatissimusDorsi_S_VP1'], k*[ 0.0112 ; 0.0143 ; -0.0236] -  CoM_Thorax' ;... 
    [ 'LThorax_LatissimusDorsi_S_VP1'], k*[ 0.0112 ; 0.0143 ; 0.0236] -  CoM_Thorax' ;... 
    
    [ 'RThorax_LatissimusDorsi_I_VP1'], k*[0.1657 ; 0.2555 ; 0.0087]  -  CoM_Thorax' ;... 
    [ 'LThorax_LatissimusDorsi_I_VP1'], k*[0.1657 ; 0.2555 ; -0.0087] -  CoM_Thorax' ;... 

    [ 'RThorax_SerratusAnterior_M_VP1'], k*[0.0470 ; 0.1746 ; 0.0635]  -  CoM_Thorax' ;... 
    [ 'LThorax_SerratusAnterior_M_VP1'], k*[0.0470 ; 0.1746 ; -0.0635]  -  CoM_Thorax' ;... 

    ['RThorax_SerratusAnterior_I_VP1'], k*[0.0222 ; 0.1608 ; 0.0891] -  CoM_Thorax' ;... 
    ['LThorax_SerratusAnterior_I_VP1'], k*[0.0222 ; 0.1608 ; -0.0891] -  CoM_Thorax' ;... 

    ['RThorax_PectoralisMinor_VP1'], k*[-0.1007 ; 0.4014 ; 0.0604] - CoM_Thorax' ;... 
    ['LThorax_PectoralisMinor_VP1'], k*[-0.1007 ; 0.4014 ; 0.0604] - CoM_Thorax' ;... 

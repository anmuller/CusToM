...
Scapula_position_set = {...
    ...
    [Side 'Thorax_BicepsL_o'],k*Mirror*([-0.03123;-0.02353;-0.01305])-Scapula_CoM;...
    [Side 'Thorax_BicepsL_via1'],k*Mirror*([-0.02094;-0.01309;-0.00461])-Scapula_CoM;...
    [Side 'Thorax_BicepsS_o'],k*Mirror*([0.01268;-0.03931;-0.02625])-Scapula_CoM;...
    [Side 'Thorax_BicepsS_via1'],k*Mirror*([0.00093;-0.06704;-0.01593])-Scapula_CoM;...
    [Side 'Thorax_Triceps_o'],k*Mirror*([-0.04565;-0.04073;-0.01377])-Scapula_CoM;...
    
    % Muscles adapted from (Puchaud et al. 2019)
    [Side '_Scapula_DELT1-P3'],k*Mirror*([0.04347;-0.03252;0.00099])-Scapula_CoM;...
    [Side '_Scapula_DELT2-P3'],k*Mirror*([5e-05;0.00294;0.02233])-Scapula_CoM;...
    [Side '_Scapula_DELT2-P4'],k*Mirror*([-0.01078;-0.00034;0.0062])-Scapula_CoM;...
    [Side '_Scapula_DELT3-P1'],k*Mirror*([-0.05573;0.00122;-0.02512])-Scapula_CoM;...
    [Side '_Scapula_DELT3-P2'],k*Mirror*([-0.07247;-0.03285;0.01233])-Scapula_CoM;...
    [Side '_Scapula_SUPSP-P2'],k*Mirror*([-0.01918;0.00127;-0.01271])-Scapula_CoM;...
    [Side '_Scapula_SUPSP-P3'],k*Mirror*([-0.044;-0.01512;-0.05855])-Scapula_CoM;...
    [Side '_Scapula_INFSP-P2'],k*Mirror*([-0.07382;-0.05476;-0.04781])-Scapula_CoM;...
    [Side '_Scapula_SUBSC-P2'],k*Mirror*([-0.01831;-0.05223;-0.02457])-Scapula_CoM;...
    [Side '_Scapula_SUBSC-P3'],k*Mirror*([-0.07246;-0.03943;-0.06475])-Scapula_CoM;...
    [Side '_Scapula_TMIN-P2'],k*Mirror*([-0.09473;-0.07991;-0.04737])-Scapula_CoM;...
    [Side '_Scapula_TMIN-P3'],k*Mirror*([-0.09643;-0.08121;-0.05298])-Scapula_CoM;...
    [Side '_Scapula_TMAJ-P2'],k*Mirror*([-0.10264;-0.10319;-0.05829])-Scapula_CoM;...
    [Side '_Scapula_TMAJ-P3'],k*Mirror*([-0.10489;-0.10895;-0.07117])-Scapula_CoM;...
    [Side '_Scapula_LAT1-P2'],k*Mirror*([-0.07982;-0.079943;-0.02428])-Scapula_CoM;...
    [Side '_Scapula_LAT1-P3'],k*Mirror*([-0.11118;-0.089323;-0.06022])-Scapula_CoM;...
    [Side '_Scapula_LAT2-P2'],k*Mirror*([-0.07875;-0.097117;-0.02023])-Scapula_CoM;...
    [Side '_Scapula_LAT2-P3'],k*Mirror*([-0.10544;-0.12896;-0.064597])-Scapula_CoM;...
    [Side '_Scapula_LAT3-P2'],k*Mirror*([-0.06598;-0.12735;-0.024183])-Scapula_CoM;...
    [Side '_Scapula_LAT3-P3'],k*Mirror*([-0.10059;-0.16313;-0.059077])-Scapula_CoM;...
    [Side '_Scapula_CORB-P1'],k*Mirror*([0.0125;-0.04127;-0.02652])-Scapula_CoM;...
    [Side '_Scapula_CORB-P2'],k*Mirror*([0.00483;-0.06958;-0.01563])-Scapula_CoM;...
%     [Side '_Scapula_TRIlong-P1'],k*Mirror*([-0.04565;-0.04073;-0.01377])-Scapula_CoM;...
%     [Side '_Scapula_BIClong-P1'],k*Mirror*([-0.03123;-0.02353;-0.01305])-Scapula_CoM;...
%     [Side '_Scapula_BIClong-P2'],k*Mirror*([-0.02094;-0.01309;-0.00461])-Scapula_CoM;...
%     [Side '_Scapula_BICshort-P1'],k*Mirror*([0.01268;-0.03931;-0.02625])-Scapula_CoM;...
%     [Side '_Scapula_BICshort-P2'],k*Mirror*([0.00093;-0.06704;-0.01593])-Scapula_CoM;...
    [Side '_Scapula_trap_acr-P1'],k*Mirror*([-0.02;0.0004;-0.0125])-Scapula_CoM;...
    [Side '_Scapula_levator_scap-P1'],k*Mirror*([-0.069;0.0062;-0.0938])-Scapula_CoM;...
    [Side '_Scapula_trap_acr-P1'],k*Mirror*([-0.02;0.0004;-0.0125])-Scapula_CoM;...
    [Side '_Scapula_rhomboid_min-P2'],k*Mirror*([-0.0798;-0.009;-0.095])-Scapula_CoM;...
    [Side '_Scapula_rhomboid_maj-P2'],k*Mirror*([-0.1052;-0.085;-0.095])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_1-P1'],k*Mirror*([-0.1;-0.1061;-0.0852])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_2-P1'],k*Mirror*([-0.1;-0.1059;-0.0839])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_3-P1'],k*Mirror*([-0.1;-0.1038;-0.0808])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_4-P1'],k*Mirror*([-0.098;-0.1005;-0.0795])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_5-P1'],k*Mirror*([-0.088;-0.065;-0.0805])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_6-P1'],k*Mirror*([-0.08;-0.05;-0.079])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_7-P1'],k*Mirror*([-0.074;-0.03;-0.085])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_8-P1'],k*Mirror*([-0.076;-0.0295;-0.0891])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_9-P1'],k*Mirror*([-0.07;-0.0074;-0.0927])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_10-P1'],k*Mirror*([-0.0594;0.0017;-0.0897])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_11-P1'],k*Mirror*([-0.0513;0.0068;-0.0877])-Scapula_CoM;...
    [Side '_Scapula_serr_ant_12-P1'],k*Mirror*([-0.036;0;-0.082])-Scapula_CoM;...
    };

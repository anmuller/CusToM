...
eh = 0.140;
L_humerus = 2*0.1674;
k_Pennestri2custom = 1;%L_humerus/(eh-dh)*k; % Humerus length equality
Pennestri2custom = k_Pennestri2custom*[1 0 0;0 0 1;0 -1 0];
...
%     ['RThorax_Coracobrachialis_i'],Pennestri2custom*[0.174 0.021 0]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['RThorax_Deltoid_i'],Pennestri2custom*[0.106 -0.024 -0.011]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['RThorax_LatissimusDorsi_i'],Pennestri2custom*[0 0 -0.013]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['RThorax_PectoralisMajor_i'],Pennestri2custom*[0.017 -0.013 0]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['RThorax_Supraspinatus_i'],Pennestri2custom*[-0.014 0.017 0.027]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['RThorax_Infraspinatus_i'],Pennestri2custom*[0.028 -0.019 0.027]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['RThorax_Trapezius_i'],Pennestri2custom*[0.031 0 0.024]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['RThorax_BicepsBrachii2_i'],Pennestri2custom*[0.252 0.021 0]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
...
%     ['LThorax_Coracobrachialis_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.174 0.021 0]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
%     ['LThorax_Deltoid_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.106 -0.024 -0.011]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
%     ['LThorax_LatissimusDorsi_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0 0 -0.013]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
%     ['LThorax_PectoralisMajor_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.017 -0.013 0]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
%     ['LThorax_Supraspinatus_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[-0.014 0.017 0.027]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
%     ['LThorax_Infraspinatus_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.028 -0.019 0.027]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
%     ['LThorax_Trapezius_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.031 0 0.024]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
%     ['LThorax_BicepsBrachii2_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.252 0.021 0]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
...
%     ['RThorax_Coracobrachialis_i'],Pennestri2custom*[0.174 0.021 0]';...
%     ['RThorax_Deltoid_i'],Pennestri2custom*[0.106 -0.024 -0.011]';...
%     ['RThorax_LatissimusDorsi_i'],Pennestri2custom*[0 0 -0.013]';...
%     ['RThorax_PectoralisMajor_i'],Pennestri2custom*[0.017 -0.013 0]';...
%     ['RThorax_Supraspinatus_i'],Pennestri2custom*[-0.014 0.017 0.027]';...
%     ['RThorax_Infraspinatus_i'],Pennestri2custom*[0.028 -0.019 0.027]';...
%     ['RThorax_Trapezius_i'],Pennestri2custom*[0.031 0 0.024]';...
%     ['RThorax_BicepsBrachii2_i'],Pennestri2custom*[0.252 0.021 0]';...
    
    ['RThorax_TricepsBrachii2_i'],Pennestri2custom*[0.038 0.027 -0.02]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
    ['RThorax_BicepsBrachii1_i'],Pennestri2custom*[0.038 0 0.01]'+Thorax_ShoulderRightNode'+Thorax_T12L1JointNode';...
%     ['LThorax_Coracobrachialis_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.174 0.021 0]';...
%     ['LThorax_Deltoid_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.106 -0.024 -0.011]';...
%     ['LThorax_LatissimusDorsi_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0 0 -0.013]';...
%     ['LThorax_PectoralisMajor_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.017 -0.013 0]';...
%     ['LThorax_Supraspinatus_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[-0.014 0.017 0.027]';...
%     ['LThorax_Infraspinatus_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.028 -0.019 0.027]';...
%     ['LThorax_Trapezius_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.031 0 0.024]';...
%     ['LThorax_BicepsBrachii2_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.252 0.021 0]';...
    ['LThorax_TricepsBrachii2_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.038 0.027 -0.02]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...
    ['LThorax_BicepsBrachii1_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.038 0 0.01]'+Thorax_ShoulderLeftNode'+Thorax_T12L1JointNode';...

...
Thorax_position_set= {...
    ...
    ['RThorax_Coracobrachialis_i'],Pennestri2custom*[0.174 0.021 0]'-CoM_Thorax';...
    ['RThorax_Deltoid_i'],Pennestri2custom*[0.106 -0.024 -0.011]'-CoM_Thorax';...
    ['RThorax_LatissimusDorsi_i'],Pennestri2custom*[0 0 -0.013]'-CoM_Thorax';...
    ['RThorax_PectoralisMajor_i'],Pennestri2custom*[0.017 -0.013 0]'-CoM_Thorax';...
    ['RThorax_Supraspinatus_i'],Pennestri2custom*[-0.014 0.017 0.027]'-CoM_Thorax';...
    ['RThorax_Infraspinatus_i'],Pennestri2custom*[0.028 -0.019 0.027]'-CoM_Thorax';...
    ['RThorax_Trapezius_i'],Pennestri2custom*[0.031 0 0.024]'-CoM_Thorax';...
    ['RThorax_BicepsBrachii2_i'],Pennestri2custom*[0.252 0.021 0]'-CoM_Thorax';...
    ['RThorax_TricepsBrachii2_i'],Pennestri2custom*[0.038 0.027 -0.02]'-CoM_Thorax';...
    ['RThorax_BicepsBrachii1_i'],Pennestri2custom*[0.038 0 0.01]'-CoM_Thorax';...
    ['LThorax_Coracobrachialis_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.174 0.021 0]'-CoM_Thorax';...
    ['LThorax_Deltoid_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.106 -0.024 -0.011]'-CoM_Thorax';...
    ['LThorax_LatissimusDorsi_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0 0 -0.013]'-CoM_Thorax';...
    ['LThorax_PectoralisMajor_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.017 -0.013 0]'-CoM_Thorax';...
    ['LThorax_Supraspinatus_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[-0.014 0.017 0.027]'-CoM_Thorax';...
    ['LThorax_Infraspinatus_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.028 -0.019 0.027]'-CoM_Thorax';...
    ['LThorax_Trapezius_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.031 0 0.024]'-CoM_Thorax';...
    ['LThorax_BicepsBrachii2_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.252 0.021 0]'-CoM_Thorax';...
    ['LThorax_TricepsBrachii2_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.038 0.027 -0.02]'-CoM_Thorax';...
    ['LThorax_BicepsBrachii1_i'],[1 0 0;0 1 0;0 0 -1]*Pennestri2custom*[0.038 0 0.01]'-CoM_Thorax';...
    };
